...
Cinerex is not a utility. It's a mirror — it reflects who you are as a viewer. The design should feel like stepping into a private, dimly lit film archive that was built specifically for you. It should feel **curated, personal, and a little cinematic itself.**
...
If a user's OS is in light mode, they still see the dark UI. A small note in settings: *"Cinerex is designed for the dark."*
...
**Wordmark:** CINEREX — Playfair Display, all caps, moderate tracking (`0.15em`). The "AI" has a very subtle amber color distinguishing it from the rest.
