...
export default function AntiRecCard({ item }: { item: AntiRecommendation }) {
  ...
  return (
    <article className="panel grid overflow-hidden border-[rgba(200,96,96,0.3)] bg-[rgba(200,96,96,0.05)] p-0 md:grid-cols-[120px_1fr]">
      ...
      <div className="space-y-3 p-5">
        <div className="flex items-center justify-between gap-3">
          <div>
            <p className="text-xs uppercase tracking-[0.2em] text-negative">Don’t bother</p>
