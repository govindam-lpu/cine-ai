...
@router.post("/serializd")
def scrape_serializd(_: ScrapeRequest) -> dict:
    raise HTTPException(status_code=501, detail={"code": "NOT_IMPLEMENTED", "message": "Serializd sync is Phase 2"})
